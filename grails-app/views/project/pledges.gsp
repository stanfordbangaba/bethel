	...
	<body>
		...
		<div id="list-project" class="content scaffold-list" role="main">
				...
				<g:if test="${projectInstance?.name}">
					...
					<li class="fieldcontain">
						<span id="receipts-label" class="property-label">Balance</span>
							...
							<span class="property-value" aria-labelledby="receipts-label">
								<bang:balance collection="${pledgeInstanceList}" var="amount" targetAmount="${projectInstance?.targetAmount}"/>
							</span>
			...
			<div id="search-results">
				<g:render template="/pledge/listbody"></g:render>
			</div>
		</div>
	</body>
</html>
